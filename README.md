...
1. **Author-module familiarity** — git blame at merge-base (line ownership and windowed line churn before this PR) plus git log commit counts and recency up to merge-base over 6 months, per changed file (language-agnostic); files **added in this PR** characterize as **high (greenfield)** by change kind, distinct from first-touch **modified** files with zero pre-PR history
