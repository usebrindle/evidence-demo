...
You are an autonomous coding agent working on a software project via the Cursor CLI.
...
For any story that changes UI, verify it works in the browser using the cursor-ide-browser MCP tools:

1. Navigate to the relevant page
2. Verify the UI changes work as expected
3. Take a screenshot if helpful for the progress log

If browser MCP is not available, note in your progress report that manual browser verification is needed.
